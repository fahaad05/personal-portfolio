...
export default async function ProjectsPage() {
  ...
  const featured = allProjects.find((project) => project.slug === "project1")!;
  const top2 = allProjects.find((project) => project.slug === "project2")!;
  const top3 = allProjects.find((project) => project.slug === "project3")!;
